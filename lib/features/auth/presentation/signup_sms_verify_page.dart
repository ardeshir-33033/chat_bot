...
class SignUpSmsVerifyPage extends StatelessWidget {
  final TextEditingController codeController = TextEditingController();

  SignUpSmsVerifyPage({super.key});
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const SignUpCreatePasswordPage(),
                    ),
                  );
                },
                ...
                child: const Text('تایید', style: TextStyle(fontSize: 16)),
              ),
